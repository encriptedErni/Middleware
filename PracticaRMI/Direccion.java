...
class crearDireccion {
            ...
            if (message instanceof TextMessage) {
                ...
                try {
                    ...
                    if (msg.getText().equals("TerminoDeMandar")) {
                        ...
                        if ((distrito.equals(distritos.get(0)) || distrito.equals(distritos.get(1)))
                                && precio > Integer.parseInt(precios.get(0))) {
    ...
    public crearDireccion(Session session, Topic topic) {
        try {
            ...
            HashMap<String,List<String>> filtros= getFilterData1.getFilterData("Direccion");
            this.distritos=filtros.get("Distritos");
            this.precios=filtros.get("Precios");
